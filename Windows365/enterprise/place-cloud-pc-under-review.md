...
2. Configure the storage account with the following settings;
    ...
    After the storage account is created, you must also apply a lock policy. For full details on how to configure Azure Blob Storage for immutability and adherence to regulations like SEC Rule 17a-4, see the full compliance assessment located in the Cohasset report in the [Microsoft Service Trust Center](https://aka.ms/AzureWormStorage).
