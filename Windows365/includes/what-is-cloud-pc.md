...
In Windows 365 Enterprise, Business, and Government, end users have a 1:1 relationship with their Cloud PC. It’s their own personal PC in the cloud. With [Windows 365 Frontline](/enterprise/introduction-windows-365-frontline.md), multiple users can nonconcurrently access a single Cloud PC.

Users can connect to their Cloud PC by using [windows365.microsoft.com](https://windows365.microsoft.com/). [Browser and app-based access](/windows-365/end-user-access-cloud-pc) is available for Windows, Mac, iOS, and Android devices. Desk-based users can also use [Windows 365 Link](/windows-365/link/) to connect securely to your Windows 365 Cloud PC in seconds.
